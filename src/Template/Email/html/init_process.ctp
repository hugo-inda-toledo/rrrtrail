                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      <tr>
                                                          <td>
                                                                <?php echo
                                                                    $this->Html->image(
                                                                        'cid:database-info-id',
                                                                        [
                                                                            'width' => 250,
                                                                            'height' => 200,
                                                                            'border' => 0,
                                                                            'alt' => __('Starting process').'!',
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;" class="padding-copy"><?php echo __("Load started").'!';?></td>
                                        </tr>
                                        <tr>
                                            <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy"><?php echo __('The master products process load has started for the [{0}] {1} - {2} store for the day {3}', [$data['store']['store_code'], $data['company']['company_name'], $data['store']['store_name'], $data['master_date']->format('d-m-Y')]).'.';?></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
