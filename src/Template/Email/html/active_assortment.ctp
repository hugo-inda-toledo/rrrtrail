                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #666666; text-align:center; line-height: 30px;" st-content="fulltext-content">
                                                <?php
                                                   echo __('Attached are links to get the report assortment of {0} {1} ({2}) of the day {3}', [$data['company']['company_name'], $data['store']['store_name'], $data['store']['store_code'], $data['robot_session']['calendar_date']->format('d-m H:i')]);
                                                ?>
         									 </td>
                                          </tr>
                                          <!-- End of content -->
                                         ...
                                         <tbody style="font-size: 18px;">
                                             <?php foreach($data['sections'] as $section):?>
                                                <tr>
                                                    ...
                                                    <td>
                                                         <a href="<?php echo 'http://my.zippedi.com/reports/activeAssortmentReport/download/pdf/'.$data['robot_session']->id.'/'.$section->id.'/all';?>" align="center">
                                                            <img src="cid:pdf-id" alt="" border="0" width="24" style="display:inline; border:none; outline:none; text-decoration:none;" align="center">
                                                         </a>
                                                    </td>

                                                    <td>
                                                         <a href="<?php echo 'http://my.zippedi.com/reports/activeAssortmentReport/download/xlsx/'.$data['robot_session']->id.'/'.$section->id.'/all';?>" align="center">
