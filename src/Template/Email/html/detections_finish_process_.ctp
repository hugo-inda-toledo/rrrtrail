                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      ...
                                                      <tr>
                                                          <td>
                                                                <?php 
                                                                    echo
                                                                    $this->Html->image(
                                                                        'cid:detections-finish-success-id',
                                                                        [
                                                                            'width' => 250,
                                                                            'height' => 200,
                                                                            'border' => 0,
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;" class="padding-copy"><?php echo __("Session loaded").'!';?></td>
                                        </tr>
                                        <tr>
                                            <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy"><?php echo __('The detection load process has finished at {0} {1} for the [{2}] {3} - {4} store', [date('H:i'), date('d-m-Y'), $data['store']['store_code'], $data['company']['company_name'], $data['store']['store_name'], $data['robot_session']['session_date']->format('d-m-Y')]).'.';?></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
