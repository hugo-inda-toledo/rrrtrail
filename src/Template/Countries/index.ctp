    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('country_keyword') ?></th>
                <th scope="col"><?= $this->Paginator->sort('country_iso_code2') ?></th>
                <th scope="col"><?= $this->Paginator->sort('country_iso_code3') ?></th>
