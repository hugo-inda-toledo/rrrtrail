...
<div class="categories view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        <tr>
            ...
            <td><?= $category->has('company') ? $this->Html->link($category->company->company_name, ['controller' => 'Companies', 'action' => 'view', $category->company->id]) : '' ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Section') ?></th>
            <td><?= $category->has('section') ? $this->Html->link($category->section->section_name, ['controller' => 'Sections', 'action' => 'view', $category->section->id]) : '' ?></td>
        </tr>
        <tr>
