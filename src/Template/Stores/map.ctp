														...
														<div class="col-sm-6">
															<div class="clearfix">
																<div class="col-lg-12 margin-bottom-lg">
																	<?php 
							                                            //echo $this->Html->link(__('[{0}] {1} - {2}', [$store->store_code, $store->company->company_name, $store->store_name]), ['controller' => 'Stores', 'action' => 'details', $store->store_code, 'plugin' => 'Retailers'], ['class' => 'text-lg text-medium']);
