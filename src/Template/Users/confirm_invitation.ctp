    ...
    <div class="card contain-lg style-transparent">
        <div class="card-body" style="padding: 0px;">
            ...
            <div class="row">
            	<div class="col-sm-12">
                	<h3>
                		<?php echo __('Dear {0}, please validate the information that appears below.', ucwords(strtolower($invitation->name)));?>
                	</h3>
                	<h5>
                		<?php echo __('Then create a password of at least 6 characters to end the process.');?>
                	</h5>
                </div>
            </div>
            <br>
            <?php echo $this->Form->create(null, array('type' => 'post', 'class' => 'form-vertical login-form', 'url' => ['controller' => 'Users', 'action' => 'confirmInvitation'], 'id' => 'loginForm')); ?>
	            <div class="row">
	                <div class="col-sm-6">
	                    <div class="card">
	                ...
	                <div class="col-sm-6">
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<p class="form-control-static"><?php echo $invitation->name;?></p>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<label><?php echo __('Last name');?></label>
											<p class="form-control-static"><?php echo $invitation->last_name;?></p>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-12">
										<div class="form-group">
											...
											<p class="form-control-static"><?php echo $invitation->email;?></p>
										</div>
									</div>
								</div>
								<?php echo $this->form->hidden('hash_code', ['value' => $invitation->hash_code]); ?>
							</div>
						</div>
						...
						<div class="card">
							...
							<div class="card-body">
		                        ...
		                        <br/>
		                        <?php echo $this->Form->button(__('Join now'), ['class' => 'btn btn-primary btn-raised pull-right']); ?>
							</div>
						</div>
	                </div>
