...
<?php echo $this->Form->create($user, ['url' => ['controller' => 'Users', 'action' => 'edit'], 'class' => 'form']);?>
    <div class="panel panel-default content">
        <div class="panel-heading">
            <?php echo __('Edit the user fields');?>
        </div>
            ...
            <div class="panel panel-default content" id="users-suppliers-panel-div">
                ...
                <div class="panel-body" id="users-suppliers-panel-body-div">
                    <?php if(count($users_suppliers) > 0):?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-stripped" id="users-suppliers-table">
                                <thead>
                                    <tr>
                                ...
                                <?php foreach($users_suppliers as $user_supplier):?>
                                    <tr id="user-supplier-row-<?php echo $user_supplier->id;?>">
                                        <td><?php echo $user_supplier->supplier->supplier_name; ?></td>
                                        <td><?php echo $user_supplier->company->company_name; ?></td>
                                        <td><?php echo $user_supplier->store->store_name.' ['.$user_supplier->store->store_code.']'; ?></td>
                                        <td><?php echo $user_supplier->section->section_name; ?></td>
                                        <td><?php echo $this->Form->button($this->Html->tag('i', '', ['class' => 'fa fa-times']), ['escape' => false, 'type' => 'button','class' => 'btn btn-danger btn-xs pull-center', 'data-user-supplier-id' => $user_supplier->id, 'data-toggle' => 'modal', 'data-target' => '#delete-user-supplier-modal']); ?></td>
                                    </tr>
                                <?php endforeach;?>
                                </tbody>
                            </table>
    ...
    $(document).ready(function(){
        ...
        $("#assign-supplier-modal #companies-id").change(function() {
            ...
            if($(this).val() != ''){
                ...
                $.ajax({
                    url: webroot + 'ajax/stores/getStoresList/true',
                    data: {
                        id: $(this).val()
                    },
                    cache: false,
