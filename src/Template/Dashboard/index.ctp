...
<?php echo $this->Html->script([
    ...
    'theme-zippedi/libs/sparkline/jquery.sparkline.min.js',
    'theme-zippedi/libs/d3/d3.min.js',
    'theme-zippedi/libs/d3/d3.V3.js',
    'theme-zippedi/libs/rickshaw/rickshaw.min.js',
]);?>


<?php foreach($stores_list as $company_name => $data):?>
    <?php //foreach($store_id as $data):?>
        ...
        <section>
            <div class="section-body">
                ...
                <div class="card">
                    <div class="card-head card-head-md style-<?php echo $data['company']->company_class;?>">
                        <header style="margin-top: 10px;"><?php echo __('{0} Dashboard', $company_name);?></header>
                        <div class="tools">
                            <?php echo $this->Html->image('companies/'.$data['company']->company_logo, ['class' => 'pull-right', 'style' => 'width: 55px;']); ?>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
