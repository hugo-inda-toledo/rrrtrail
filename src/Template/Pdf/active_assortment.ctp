            ...
            <thead>
                <tr>
                    <th class="text-center" style="background-color: #5c5c5c !important;">
                    	<?php echo $this->Html->tag('h4', __('Active Assortment Report'), ['style' => 'color:#FFF !important;']); ?>

                        <?php if($robot_session->store->company->company_keyword == 'jumbo'):?>
                            <?php echo $this->Html->tag('small', __('Cataloged, enabled and with positive stock products not found in room'), ['style' => 'color:#FFF !important;']); ?>
                        <?php else:?>
                            <?php echo $this->Html->tag('small', __('Cataloged and enabled products not found in room'), ['style' => 'color:#FFF !important;']); ?>
                        <?php endif;?>
