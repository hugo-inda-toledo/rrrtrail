            ...
            <thead>
                <tr>
                    <th class="text-center" style="background-color: #5c5c5c !important;">
                    	<?php echo $this->Html->tag('h4', __('Negative Assortment Report'), ['style' => 'color:#FFF !important;']); ?>
                        <?php echo $this->Html->tag('small', __('Cataloged, enabled and blocked products with negative or without stock not found in room'), ['style' => 'color:#FFF !important;']); ?>
                    </th>
                </tr>
                <tr>
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php else:?>
                                                                    ...
                                                                    <?php echo $this->Html->tag('span', __('Enabled'), ['class' => 'label label-success']);?>
