			...
			<div class="headerbar">
					...
					<ul class="header-nav header-nav-options">
						<li class="header-nav-brand">
							<div class="brand-holder">
								...
								<?php echo $this->Html->link($this->Html->image('onlyletterswhite.png', ['class' => 'img-responsive', 'style' => 'margin-top: -14px;']), ['controller' => 'Stores', 'action' => 'map', 'plugin' => 'Suppliers'], ['escape' => false, 'class' => 'navbar-brand']);?>
							</div>
						</li>
						<li>
				...
				<div class="headerbar-right">
					<ul class="header-nav header-nav-options">
						...
						<?php if($this->request->session()->read('Auth.Companies') !== null && count($this->request->session()->read('Auth.Companies')) > 0):?>
							
							<li>
								<?php echo $this->Html->link(__('Retailer Interface'), ['controller' => 'Stores', 'action' => 'map', 'plugin' => 'Retailers'], ['class' => 'btn btn-info btn-sm', 'style' => 'color: #ffffff;background-color: #00bcd4;border-color: #00bcd4;'])?>
							</li>
							...
							<ul id="main-menu" class="gui-controls">
	                            ...
	                            <li>
									<?php echo $this->Html->link(
										...
										$this->Html->tag('span', __('My Stores'), ['class' => 'title']), '/map', [
										'escape' => false
									]);?>
								</li>
								...
								<li class="gui-folder">
									...
									<ul>
										<li>
											<?php echo $this->Html->link($this->Html->tag('span', __('Assortment'), ['class' => 'title']), ['controller' => 'RobotReports', 'action' => 'assortmentReport'], ['escape' => false]);?>
										</li>
										<li>
											<?php echo $this->Html->link($this->Html->tag('span', __('Price Differences'), ['class' => 'title']), ['controller' => 'RobotReports', 'action' => 'priceDifferenceReport'], ['escape' => false]);?>
										</li>
										<li>
											<?php echo $this->Html->link($this->Html->tag('span', __('Stock Alerts'), ['class' => 'title']), ['controller' => 'RobotReports', 'action' => 'stockOutReport'], ['escape' => false]);?>
										</li>
									</ul>
								</li>								
