				...
				<div class="headerbar-right">
					<ul class="header-nav header-nav-options">
						...
						<?php if($this->request->session()->read('Auth.Suppliers') !== null && count($this->request->session()->read('Auth.Suppliers')) > 0):?>
							...
							<li>
								<?php echo $this->Html->link(__('Suppliers Interface'), ['controller' => 'Stores', 'action' => 'map', 'plugin' => 'Suppliers'], ['class' => 'btn btn-info'])?>
							</li>
							...
							<ul id="main-menu" class="gui-controls">
	                            ...
	                            <li>
									<?php echo $this->Html->link(
										...
										$this->Html->tag('span', __('My Stores'), ['class' => 'title']), ['controller' => 'Stores', 'action' => 'map'], [
										'escape' => false
									]);?>
								</li>
