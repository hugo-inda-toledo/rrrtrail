 ...
 *
 *
 * @method \Retailers\Model\Entity\RobotReport[]|\Cake\Datasource\ResultSetInterface paginate($object = null, array $settings = [])
 */
class RobotReportsController extends AppController
{
    ...
    **/
    ...
    public function getSessionStadistics($store_code = null, $session_code = false, $show = false){
        ...
        $http = new Client();
        $request_token = $http->post($this->endpoint.'/auth', json_encode($this->auth_data), ['type' => 'json', 'ssl_verify_peer' => false]);
        ...
        $robot_response = $http->get($url, ['store' => $store_code, 'session' => $session_code], ['ssl_verify_peer' => false]);
    ...
    **/
    public function getSessionsList($store_code = null, $list = false, $ajax = false, $show = false){
        ...
        $robot_response = $http->get($url, ['store' => $store_data->store_code], ['ssl_verify_peer' => false]);
    ...
    **/
    public function getFullSessionsList($store_code = null, $session_code = null, $date = null, $days = null, $list = false, $ajax = false, $show = false){
        ...
        $robot_response = $http->get($url, ['store' => $store_data->store_code, $opts], ['ssl_verify_peer' => false]);
    ...
    **/
    public function getSessionStatus($store_code = null, $session_code = null, $show = false){
        ...
        $robot_response = $http->get($url, ['store' => $store_data->store_code, 'session' => $session_code], ['ssl_verify_peer' => false]);
    ...
    **/
    public function getSessionData($store_code = null, $session_code = null){
        ...
        $response = $http->get($url, ['store' => $store_code, 'session' => $session_code], ['ssl_verify_peer' => false]);
    ...
    public function getAllLabelsSumary($supermarket_code = null, $session_code = null, $update = false, $show = false){
        ...
        $http = new Client();
        $request_token = $http->post($this->endpoint.'/auth', json_encode($auth_data), ['type' => 'json', 'ssl_verify_peer' => false]);
        ...
        $response = $http->get($url, ['store' => $supermarket_code, 'session' => $session_code], ['ssl_verify_peer' => false]);
    ...
    *****/
    public function getPriceDifferences($supermarket_code = null, $session_code = null, $show = false){
        ...
        $response = $http->get($url, ['store' => $supermarket_code, 'session' => $session_code, 'source' => 'q'], ['ssl_verify_peer' => false]);
    ...
    *****/
    public function getStockOut($supermarket_code = null, $session_code = null, $show = false){
        ...
        $robot_response = $http->get($url, ['store' => $supermarket_code, 'session' => $session_code], ['ssl_verify_peer' => false]);
    ...
    *****/
    public function getLabelCrop($store_code = null, $session_code = null, $detection_id = null, $type = null, $return_type = null){
        ...
        $response = $http->get($url, ['store' => $store_code, 'session' => $session_code, 'detection_id' => $detection_id, 'type' => $type], ['ssl_verify_peer' => false]);
    ...
    *****/
    public function getFacingCrop($store_code = null, $session_code = null, $detection_id = null, $return_type = null){
        ...
        $response = $http->get($url, ['store' => $store_code, 'session' => $session_code, 'detection_id' => $detection_id], ['ssl_verify_peer' => false]);
