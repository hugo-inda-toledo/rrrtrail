        ...
        <div class="panel-body" id="users-data-div">
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group" style="display:none;" id="password-form-div">
                        <label><?php echo __('Password'); ?></label>
                        <?php echo $this->Form->input('Users.password', ['class' => 'form-control', 'type' => 'password', 'label' => false]);?>
                    </div>
                    <div class="checkbox checkbox-inline checkbox-styled">
                        <label>
                            <?php echo $this->Form->checkbox('send_invitation', ['checked', 'id' => 'send_invitation']);?>
                            <?php echo __('Send invitation');?>
                        </label>
                    </div>
                </div>
            </div>                
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group" id="company-select-div">
                                <label>Company</label>
                                <?php echo $this->Form->select('Companies.id', $companies, ['type' => 'select', 'class' => 'form-control', 'label' => false, 'empty' => __('Select a company'), 'id' => 'companies-id-retailer']);?>
                            </div>
...
<?php $this->Html->scriptStart(array('block' => 'scriptBottom', 'inline' => false)); ?>
    ...
    $(document).ready(function(){
        ...
        $('#send_invitation').change(function() {
            if($(this).is(":checked")) {
                $('#password-form-div').slideUp();
                $('#users-password').val('');
                $('#users-password').removeAttr('required');
            }
            else{
                $('#password-form-div').slideDown();
                $('#users-password').attr('required', 'required');
                $('#users-password').val('');
            }       
        });
        
        // Start Users Companies
        $("#assign-company-modal #companies-id-retailer").change(function() {
            ...
            if($(this).val() != ''){
                ...
                $.ajax({
                    url: webroot + 'ajax/management/stores/getStoresList/',
                    data: {
                        id: $(this).val()
                    },
                    cache: false,
                ...
                $.ajax({
                    url: webroot + 'ajax/management/sections/getSectionsList/',
                    data: {
                        id: $(this).val()
                    },
                    cache: false,
        ...
        $("#assign-supplier-modal #companies-id").change(function() {
            ...
            if($(this).val() != ''){
                ...
                $.ajax({
                    url: webroot + 'ajax/management/suppliers/getSuppliersList/',
                    data: {
                        id: $(this).val()
                    },
                    cache: false,
    ...
    function assignUserCompany(){
        var company_id = $('#assign-company-modal #companies-id-retailer').val();
        var company_name = $('#assign-company-modal #companies-id-retailer').find(":selected").text();
        ...
        if(company_id != '' && store_id != '' && section_id != ''){
            ...
            $('#users-companies-panel-body-div').prepend('<div class="well"><h4><?php echo __('Data to associate');?></h4><div class="row"><div class="col-sm-6"><ul><li><?php echo __('Company');?>: <strong>'+company_name+'</strong></li><li><?php echo __('Store');?>: <strong>'+store_name+'</strong></li><li><?php echo __('Section');?>: <strong>'+section_name+'</strong></li></ul></div><div class="col-sm-6"><label class="checkbox-inline checkbox-styled"><input name="UsersCompanies['+x+'][assortment_report]" type="checkbox" value="assortmentReport"><span><?php echo __('Assortment Report');?></span></label><label class="checkbox-inline checkbox-styled"><input name="UsersCompanies['+x+'][price_differences]" type="checkbox" value="priceDifferenceReport"><span><?php echo __('Price Difference Report');?></span></label><label class="checkbox-inline checkbox-styled"><input name="UsersCompanies['+x+'][stock_alert]" type="checkbox" value="stockOutReport"><span><?php echo __('Stock Alert Report');?></span></label></div></div></div>');

            x = x + 1;

            $("#assign-company-modal #companies-id-retailer").val('');
    ...
    function assignUserSupplier(){
        ...
        if(company_id != '' && store_id != '' && supplier_id != '' && section_id != ''){
            ...
            $('#users-suppliers-panel-body-div').prepend('<div class="well"><h4><?php echo __('Data to associate');?></h4><div class="row"><div class="col-sm-6"><ul><li><?php echo __('Company');?>: <strong>'+company_name+'</strong></li><li><?php echo __('Store');?>: <strong>'+store_name+'</strong></li><li><?php echo __('Section');?>: <strong>'+section_name+'</strong></li><li><?php echo __('Supplier');?>: <strong>'+supplier_name+'</strong></li></ul></div><div class="col-sm-6"><label class="checkbox-inline checkbox-styled"><input name="UsersSuppliers['+y+'][assortment_report]" type="checkbox" value="assortmentReport"><span><?php echo __('Assortment Report');?></span></label><label class="checkbox-inline checkbox-styled"><input name="UsersSuppliers['+y+'][price_differences]" type="checkbox" value="priceDifferenceReport"><span><?php echo __('Price Difference Report');?></span></label><label class="checkbox-inline checkbox-styled"><input name="UsersSuppliers['+y+'][stock_alert]" type="checkbox" value="stockOutReport"><span><?php echo __('Stock Alert Report');?></span></label></div></div></div>');
