...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'username' => ['type' => 'string', 'length' => 70, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'is_admin' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'active' => 1,
                'is_admin' => 1,
                'created' => '2018-07-03 13:37:37',
                'modified' => '2018-07-03 13:37:37'
            ],
        ];
        parent::init();
    }
